...
//----- PASS IN A POINTER TO THE FBO FROM OF_APP TO INTS CONTEXT CAN BE SHARED AND
//----- ACCESSED IN BOTH WINDOWS
void SurfaceManager::assign_projection_fbo(ofFbo* projection_fbo){
    this->projection_fbo = projection_fbo;
}
